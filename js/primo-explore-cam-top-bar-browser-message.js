...
app.controller('PrmTopbarAfterController', ['$location', '$mdDialog', '$timeout', '$mdToast', '$sessionStorage',
    function ($location, $mdDialog, $timeout, $mdToast, $sessionStorage) {
        var vm = this;
        ...
        if(browserVersion.displayMessage) {
            ...
            var templateString = '<div layout="row" layout-align="center center" style="width: 100%" class="bar alert-bar layout-align-center-center layout-row">'+
                ...
                '<span translate="nui.browseVersions" translate-values="{placeholders:ctrl.getPlaceHolders(\''+browserVersion.browser+'\')}" translate-compile></span>'+
                '</span>'+
                ...
                '<span class="ng-scope" translate="nui.message.dismiss">DISMISS</span>'+
                '</button>'+
                '</div>';
            ...
            $mdToast.show({
                controllerAs: 'ctrl',
                controller: function(){
                    this.onDismiss = function() {$mdToast.hide()};
